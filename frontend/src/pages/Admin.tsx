      ...
      <div className="flex-1 md:ml-64">
        ...
        <main className="p-6">
          ...
          {activeTab === "tracking" && (
            <div className="space-y-6">
              <div className="bg-card rounded-xl border border-border p-6">
                <h3 className="font-display font-semibold text-card-foreground mb-2">YES+ ASPLACE Referral Tracking</h3>
                <p className="text-muted-foreground mb-4">Track students redirected to ASPLACE registration via UTM parameters.</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-background rounded-lg p-4 border border-border">
                    ...
                    <div className="text-sm text-muted-foreground">Completed Registrations</div>
                  </div>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between py-2 border-b border-border">
                    <span className="text-muted-foreground">Registration Link:</span>
                    <span className="text-card-foreground font-medium">asplace.artofliving.org</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-border">
                    <span className="text-muted-foreground">UTM Source:</span>
                    <span className="text-card-foreground font-mono text-xs">paie</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-border">
                    <span className="text-muted-foreground">UTM Medium:</span>
                    <span className="text-card-foreground font-mono text-xs">website</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-muted-foreground">UTM Campaign:</span>
                    <span className="text-card-foreground font-mono text-xs">campus</span>
                  </div>
                </div>
              </div>

              <div className="bg-card rounded-xl border border-border p-6">
                <h3 className="font-display font-semibold text-card-foreground mb-3">Integration Details</h3>
                <p className="text-muted-foreground text-sm mb-4">
                  The YES+ page includes a direct link to ASPLACE with UTM tracking parameters. This allows Art of Living to identify registrations coming from your campus.
                </p>
                <div className="bg-muted/50 rounded-lg p-4 font-mono text-xs overflow-x-auto">
                  https://asplace.artofliving.org/register?utm_source=paie&utm_medium=website&utm_campaign=campus
                </div>
                <p className="text-muted-foreground text-sm mt-4">
                  Note: Actual registration data is managed by Art of Living. Contact them for detailed analytics and participant lists.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === "export" && (
            <div className="bg-card rounded-xl border border-border p-6 text-center">
              ...
              <h3 className="font-display font-semibold text-card-foreground mb-2">Export Data</h3>
              <p className="text-muted-foreground mb-6">Download registration data as CSV or Excel</p>
